...
value('tableOfContents', [{
    ...
    'id': 'concurrency',
    'title': 'Едновременно изпълнение (Concurrency)',
    'description': '<p>Go предоставя възможност за едновременно изпълнение на код. Тази способност е заложена в ядрото на езика.</p><p>В този раздел разглеждаме go-нишките (goroutines) и каналите (channels), и различни начини за осъществяване на многозадачност.</p>',
    'lessons': ['concurrency']
}]).
